...
from envs.mani_skill2 import format_path
from envs.mani_skill2.agents.robots.mobile_panda import DummyMobileAgent
from envs.mani_skill2.envs.sapien_env import BaseEnv
from envs.mani_skill2.sensors.camera import CameraConfig
from envs.mani_skill2.utils.common import random_choice
from envs.mani_skill2.utils.io_utils import load_json
...
class MS1BaseEnv(BaseEnv):
    ...
    def find_urdf_path(self, model_id):
        ...
        raise FileNotFoundError(
            ...
            "`cd envs/mani_skill2/utils && python download_asset.py {}`".format(self.ASSET_UID)
        )
    ...
    def check_actor_static(self, actor: sapien.Actor, max_v=None, max_ang_v=None):
        ...
        """
        from envs.mani_skill2.utils.geometry import angle_distance

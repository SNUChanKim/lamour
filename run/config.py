...
def get_args():
    ...
    parser.add_argument(
        '--use-own-crit',
        action='store_true', 
        help='determine whether to use own criteria')
    parser.add_argument(
        '--use-env-reward',
        action='store_true', 
    ...
    parser.add_argument(
        '--actor-path', 
        default='../trained_models/sac_actor_Ant-v3_',
        help='actor model path')
    parser.add_argument(
        '--critic-path', 
        default='../trained_models/sac_critic_Ant-v3_',
    ...
    parser.add_argument('--async-env', action='store_true', default=False,
